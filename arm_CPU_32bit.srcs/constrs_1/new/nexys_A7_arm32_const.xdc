################################################################################
# Nexys-A7-100T - ARM CPU with Warning Override
################################################################################

# Override UCIO-1 error for unassigned upper bits
...
# Timing Constraints       #
############################
set_input_delay -clock sys_clk_pin -max 2.0 [get_ports { reset }]
...
set_property KEEP_HIERARCHY TRUE [get_cells Data_mem]  
set_property KEEP_HIERARCHY TRUE [get_cells Instr_mem]
